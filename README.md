...
## **1st Year (First Year)**  
- **Law and Data**: Notes and resources on the legal and ethical aspects of data science, including data privacy, regulations, and compliance.  
- **FIS**: *Foundations of Information Systems* — principles and technologies behind data management and information systems.  
- **ML**: *Machine Learning* — advanced algorithms, techniques, and applications in data science.  
- **SL**: *Statistical Learning* — foundations and practical applications of statistical learning methods.  
- **BDC**: *Big Data Computing* — big data algorithms and tools such as PySpark for distributed data processing.  
...
- **TMIRI**: *Techniques and Methodologies for Innovation and Research in Informatics* — research methods, innovation strategies, and scientific communication.  
- **SDM**: *Semantic Data Management* — semantic technologies, knowledge graphs, and intelligent data integration. 
